...
for A in range(50,51,1):
	for Threshold in range(5000,10000,125):
	
		######  for loop must be int
		Thresholdf = Threshold/10000.0
		...
		os.system('scavetool vector -p \'module(FattreewithPABO.host10.tcp) AND ("SHI: reordering density")\' -O Theta_Study/PABO_RDOutsplit2.csv -F splitcsv General-0.vec')
		os.system('scavetool vector -p \'module(FattreewithPABO.host10.tcp) AND ("SHI: packet delay")\' -O Theta_Study/PABO_PkDelayOutsplit2.csv -F splitcsv General-0.vec')
		os.system('scavetool scalar -p \'module(FattreewithPABO.host10.*) AND ("endToEndDelay:histogram:mean")\' -O Theta_Study/PABO_endToEndDelay2.csv -F csv General-0.sca')
		...
		os.system('scavetool vector -p \'module(FattreewithPABO.host10.tcp) AND ("SHI: reordering density")\' -O Theta_Study/noPABO_RDOutsplit2.csv -F splitcsv General-0.vec')
		os.system('scavetool vector -p \'module(FattreewithPABO.host10.tcp) AND ("SHI: packet delay")\' -O Theta_Study/noPABO_PkDelayOutsplit2.csv -F splitcsv General-0.vec')
		os.system('scavetool scalar -p \'module(FattreewithPABO.host10.*) AND ("endToEndDelay:histogram:mean")\' -O Theta_Study/noPABO_endToEndDelay2.csv -F csv General-0.sca')
